...
Write-Host "File: D:\projects\vendo-print\vendo-print\backend\printer\temp\1243710d-4867-4b8f-b268-bfd80679ed6e_1744038003799_printer-test.pdf"
Write-Host "Printer: EPSON L3210 Series"
Write-Host "Color: true"

try {
    # Verify file exists
    if (!(Test-Path "D:\projects\vendo-print\vendo-print\backend\printer\temp\1243710d-4867-4b8f-b268-bfd80679ed6e_1744038003799_printer-test.pdf")) {
        Write-Error "File not found: D:\projects\vendo-print\vendo-print\backend\printer\temp\1243710d-4867-4b8f-b268-bfd80679ed6e_1744038003799_printer-test.pdf"
        exit 1
    }
    ...
    Start-Process -FilePath "D:\projects\vendo-print\vendo-print\backend\printer\temp\1243710d-4867-4b8f-b268-bfd80679ed6e_1744038003799_printer-test.pdf" -Verb Print -Wait
